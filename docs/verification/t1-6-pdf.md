...
サイズ・ページ対応と `--pages` の解釈は [T1-7 確認結果](t1-7-pages.md)、結果出力は [T1-8 確認結果](t1-8-output.md) を参照。HTML は [T1-9 確認結果](t1-9-html.md) を参照。CLI への接続は [T1-10 確認結果](t1-10-cli.md) を参照。Windows の追加テストと PDF の日本語パス実機確認は未実施で、[Windows 確認リスト](../TASKS.md) に残している。
