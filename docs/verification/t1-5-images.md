...
PDF 読み込みは [T1-6 確認結果](t1-6-pdf.md)、サイズ・ページ対応は [T1-7 確認結果](t1-7-pages.md)、結果出力は [T1-8 確認結果](t1-8-output.md) を参照。HTML と CLI への接続は未着手。Windows での新しいテストと日本語パスの実機確認は未実施で、[Windows 確認リスト](../TASKS.md) に残している。
